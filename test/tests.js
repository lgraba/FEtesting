...
describe('Testin Hard', () => {
    it('Should make Logan happy!', () => {
        const errors = Immutable.fromJS({
            name: ['This field is required', 'You are too ugly to use this API']
        });

        const result = main._test.flatten(errors);
    ...
    it('Should Transform Errors', () => {
        ...
        const result = main._test.nestedMerge(errors);
